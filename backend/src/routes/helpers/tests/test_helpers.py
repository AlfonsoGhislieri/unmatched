...
def test_normalize_matchup_data():
    matchups = [
        Matchup(id=1, fighter1_id=1, fighter2_id=2, plays=100, fighter1_winrate=55.0, fighter2_winrate=45.0),
        Matchup(id=2, fighter1_id=3, fighter2_id=1, plays=200, fighter1_winrate=65.0, fighter2_winrate=35.0),
    ]
